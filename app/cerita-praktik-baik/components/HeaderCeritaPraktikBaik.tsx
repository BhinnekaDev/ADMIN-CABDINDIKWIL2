...
import { HeaderCeritaPraktikBaikProps } from "@/app/cerita-praktik-baik/interfaces/header-cerita-praktik-baik.interface";

export default function HeaderCeritaPraktikBaik({
  search,
  loading,
  setSearch,
  openAddModal,
}: HeaderCeritaPraktikBaikProps) {
  return (
