...
import { ModalHapusBeritaProps } from "@/app/berita/interfaces/modal-hapus-berita-props.interface";

export default function ModalHapusBerita({
  item,
  loading,
  onDelete,
  closeModal,
}: ModalHapusBeritaProps) {
