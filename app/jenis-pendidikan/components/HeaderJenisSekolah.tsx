...
import { HeaderJenisSekolahProps } from "@/app/jenis-pendidikan/interfaces/header-jenis-sekolah.interface";

export default function HeaderJenisSekolah({
  search,
  loading,
  setSearch,
  openAddModal,
}: HeaderJenisSekolahProps) {
  return (
