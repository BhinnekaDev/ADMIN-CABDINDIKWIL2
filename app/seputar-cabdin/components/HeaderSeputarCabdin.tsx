...
import { HeaderSeputarCabdinProps } from "@/app/seputar-cabdin/interfaces/header-seputar-cabdin.interface";

export default function HeaderSeputarCabdin({
  search,
  loading,
  setSearch,
  openAddModal,
}: HeaderSeputarCabdinProps) {
  return (
