...
import { TableLayananProps } from "@/app/layanan/interfaces/table-layanan.interface";
        ...
        <table className="table w-full">
          <thead>
            <tr>
              ...
              <th>Judul</th>
              <th className="hidden md:table-cell">Nama File</th>
          ...
          <tbody>
            {loading ? (
              ...
              paginatedData.map((layanan, index) => (
                <tr key={layanan.id}>
                  <td className="hidden sm:table-cell">
                  ...
                  <td className="hidden xl:table-cell">
                    {" "}
                    {new Date(layanan.dibuat_pada).toLocaleDateString("id-ID", {
                      day: "2-digit",
                      month: "long",
                      year: "numeric",
                    })}
                  ...
                  <td>
                    <div className="sm:hidden">
                      <button
                        ...
                        onClick={() => setMobileActionItem(layanan.id)}
                      >
                        ⋮
                      </button>
                    </div>
