...
import { ModalHapusPrakataProps } from "@/app/prakata/interfaces/modal-hapus-prakata-props.interface";

export default function ModalHapusPrakata({
  item,
  loading,
  onDelete,
  closeModal,
}: ModalHapusPrakataProps) {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
      <div className="bg-white dark:bg-[#1d232a] w-full max-w-md p-6 rounded-lg animate-slide-up">
        ...
        <input
          ...
          placeholder="Ketik nama prakata di sini"
        />
