...
import { ModalHapusLayananProps } from "@/app/layanan/interfaces/modal-hapus-layanan-props.interface";

export default function ModalHapusLayanan({
  item,
  loading,
  onDelete,
  closeModal,
}: ModalHapusLayananProps) {
    ...
    <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center">
      <div className="bg-white dark:bg-[#1d232a] w-full max-w-md p-6 rounded-lg animate-slide-up">
        ...
        <input
          ...
          placeholder="Ketik judul layanan di sini"
        />
