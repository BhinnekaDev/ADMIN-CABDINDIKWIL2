import { ModalKontakProps } from "@/app/kontak/interfaces/modal-kontak.interface";

export default function ModalKontak({
  onSubmit,
  modalInput,
  closeModal,
  editingItem,
...
`}
        ...
        <div className="relative mb-6">
          <input
            type="text"
            id="noTelp"
            value={modalInput.no_telp}
            onChange={(e) =>
              setModalInput({ ...modalInput, no_telp: e.target.value })
            }
            placeholder=" "
            className="peer block w-full border-0 border-b-2 border-gray-300  dark:border-gray-600 bg-transparent px-0 pt-4 pb-2 text-sm focus:outline-none focus:ring-0"
          />
