...
import { HeaderLokasiSekolahProps } from "@/app/lokasi/interfaces/header-lokasi-sekolah.interface";

export default function HeaderLokasiSekolah({
  search,
  loading,
  setSearch,
  openAddModal,
}: HeaderLokasiSekolahProps) {
  return (
