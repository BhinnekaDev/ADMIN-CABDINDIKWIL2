...
import { HeaderSatuanPendidikanProps } from "@/app/satuan-pendidikan/interfaces/header-satuan-pendidikan.interface";

export default function HeaderSatuanPendidikan({
  search,
  loading,
  setSearch,
  openAddModal,
}: HeaderSatuanPendidikanProps) {
  return (
